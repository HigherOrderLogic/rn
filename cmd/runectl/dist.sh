...
BLUE_RELEASE_TAR=runectl.tar.gz
: "${BLUECTL_CONFIG_DIR:?BLUECTL_CONFIG_DIR is not set. Use the runectl-{prod,staging}-dist make targets so the bluectl project-id is pinned to the right environment.}"
